...
function News() {
  return (
    <section className="min-h-screen bg-white pt-24">
      ...
      <div className="space-y-6 grid grid-cols-1 mx-5 md:grid-cols-1 md:mx-10 lg:grid lg:grid-cols-2 lg:mt-20 ">
        <div className="rounded-lg overflow-hidden border-1 ">
          ...
          <div className="md:flex">
            <div className="w-full md:w-1/2 p-6">
              ...
              <h3 className="mt-4 font-semibold text-base text-black">
                Innovations in everyday logistics: Optimization to the last mile
              </h3>
            </div>
            <div className="w-full md:w-1/2">
              <Image
